...
SCRIPT:AddHook("OnGUIAction", "DH_GUIAction", function(pid, idGui, data)
  local pname = tes3mp.GetName(pid)
...
SCRIPT:AddHook("ProcessCommand", "DH_Commands", function(pid, cmd)
  if(cmd[1] == "decorator") or (cmd[1] == "dh") or (cmd[1] == "decorate") then
    showMainGUI(pid)
  end
end)

SCRIPT:AddHook("OnPlayerCellChange", "DH_CellChange", function(pid)
